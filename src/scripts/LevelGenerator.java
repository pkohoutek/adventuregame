...
public class LevelGenerator {
	...
	/**
	 * private method uses other private helper methods to parse
	 * the level#.cfg file (# being the number of the current level generated)
	 * and generates the props, puzzles, ciphers, intro text, exit text, player 
	 * position on map, and more
	 */
	...
	/**
	 * private helper method generates the levels props
	 */
	...
	/**
	 * private helper method generates the levels trigger objects
	 */
	private void genTriggers() {
		// create new input stream for level#.cfg file
		Scanner inputStream = null;
	...
	/**
	 * private helper method generates the levels puzzles
	 */
	...
	/**
	 * private helper method generates the levels ciphers
	 */
	private void genCiphers() {
		// create new input stream for level#.cfg file
		Scanner inputStream = null;
		String filename = "level" + Integer.toString(levelNumber) + ".cfg";
		String line = "";
	...
	/**
	 * private helper method generates the player's starting position in the level
	 */
	...
	/**
	 * private helper method generates the level's introduction and exit text
	 */
